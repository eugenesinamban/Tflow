...
@section('content')
    <div class="text-center">
        ...
        <p>Eugene Sinamban operates https://tech-c-overflow.herokuapp.com (the "Site"). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.
        ...
        <p>This Privacy Policy is effective as of 2020-05-20 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.
